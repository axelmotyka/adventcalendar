...
public class Exercise12Test {
    ...
    @Test
    public void Test09() {
        Vehicle tester = new week02.exercise12.Motorcycle("Toyota", "Verso", 100,
                Motorcycle.engineType.gasoline, week02.exercise12.Motorcycle.windShield.Yes);



        assertEquals("Wrong result!", "Toyota Verso,"
                + Motorcycle.engineType.gasoline + "," + 100
                + "hps" + ", This Shield : " + week02.exercise12.Motorcycle.windShield.Yes, tester.toString());
    }


    @Test
    public void Test10() {
        Vehicle tester = new week02.exercise12.Trike("Toyota", "Verso", 100,
                Trike.engineType.gasoline, week02.exercise12.Trike.roofType.Yes);
